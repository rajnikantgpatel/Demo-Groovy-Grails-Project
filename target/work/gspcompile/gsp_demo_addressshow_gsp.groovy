...
class gsp_demo_addressshow_gsp extends GroovyPage {
...
printHtmlPart(14)
invokeTag('message','g',28,['code':("address.pincode.label"),'default':("Pincode")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(addressInstance),'field':("pincode")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
...
printHtmlPart(22)
invokeTag('message','g',55,['code':("address.state.label"),'default':("State")],-1)
printHtmlPart(23)
invokeTag('fieldValue','g',57,['bean':(addressInstance),'field':("state")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (addressInstance?.streetAddress)) {
printHtmlPart(24)
invokeTag('message','g',64,['code':("address.streetAddress.label"),'default':("Street Address")],-1)
printHtmlPart(25)
invokeTag('fieldValue','g',66,['bean':(addressInstance),'field':("streetAddress")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (addressInstance?.students)) {
printHtmlPart(26)
invokeTag('message','g',73,['code':("address.students.label"),'default':("Students")],-1)
printHtmlPart(27)
...
invokeTag('link','g',76,['controller':("student"),'action':("show"),'id':(s.id)],4)
printHtmlPart(29)
}
printHtmlPart(30)
}
...
invokeTag('link','g',85,['class':("edit"),'action':("edit"),'resource':(addressInstance)],3)
printHtmlPart(33)
...
invokeTag('form','g',88,['url':([resource:addressInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(35)
})
...
public static final long LAST_MODIFIED = 1404735910000L
