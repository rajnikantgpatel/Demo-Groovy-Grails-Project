...
class gsp_demo_studentedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(studentInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(studentInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(studentInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:studentInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
